...
class WorkerController(object):
    ...
    def __init__(self, nodemanager, gateway, config, putevent):
        ...
        self.workerinput = {
            ...
            "subordinateid": gateway.id,
            "subordinatecount": len(nodemanager.specs),
            "mainargv": sys.argv,
        }
        # TODO: deprecated name, backward compatibility only. Remove it in future
        self.subordinateinput = self.workerinput
        self._down = False
    ...
    def process_from_remote(self, eventcall):  # noqa too complex
        ...
        try:
            ...
            if eventname in ("collectionstart",):
                ...
                self._down = True
                self.workeroutput = self.subordinateoutput = kwargs["workeroutput"]
